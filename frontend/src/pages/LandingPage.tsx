...
import { Search, Settings, User, BookOpen, Activity, Award, Cpu, TabletSmartphone, Route, Moon, Sun } from 'lucide-react';
...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="font-sans relative min-h-screen bg-[#fafaf9] dark:bg-[#0f172a] text-[#333] dark:text-[#e2e8f0] overflow-x-hidden flex flex-col transition-colors duration-300">
      ...
      <header className="relative z-10 w-full bg-[#fdfdfc] dark:bg-[#1e293b] py-[12px] px-6 md:px-12 flex items-center justify-between shadow-[0_1px_4px_rgba(0,0,0,0.06)] dark:shadow-[0_1px_4px_rgba(0,0,0,0.5)] transition-colors duration-300">
        ...
        <div className="flex items-center gap-9">
          <nav className="hidden lg:flex items-center gap-6 text-[11px] font-bold text-[#555] dark:text-[#cbd5e1] tracking-wide uppercase">
            <a href="#" className="hover:text-[#1f2d4d] dark:hover:text-white transition-colors">Home</a>
            <a href="#about" className="hover:text-[#1f2d4d] dark:hover:text-white transition-colors">About</a>
            <a href="#features" className="hover:text-[#1f2d4d] dark:hover:text-white transition-colors">Features</a>
