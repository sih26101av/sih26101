 ...
 *
 * All copy and the language list come from `i18n/chatLanguages`, and the
 * bubbles / typing dots / mic / nav banner from `chat/ChatPrimitives`, shared
 * with HomeChatWidget and AdminChatWidget so the widgets stay identical.
 *
