...
## Summary
- 1154 nodes · 2341 edges · 64 communities (51 shown, 13 thin omitted)
...
Cohesion: 0.06
Nodes (36): Code, Code, CertificateUploadZone(), calculate_baseline(), EvidencePayload, BaseModel, post, UploadFile (+28 more)
...
### Community 8 - "react"
Cohesion: 0.18
Nodes (13): AdminDashboard, App(), LearnerDashboard, ProtectedRouteProps, AuthContext, AuthContextType, AuthUser, frontend_src_index (+5 more)

### Community 9 - "Code"
Cohesion: 0.14
Nodes (17): Code, Connections, In / out, Learner Dashboard (frontend shell), CompetencyOverviewTable(), LevelPips(), priorityOf(), Props (+9 more)
...
Cohesion: 0.14
Nodes (14): BaseUser, Competency, CompetencyProfile, Course, JobRole, KarmaBreakdown, KarmaMonthlyUsage, KarmaTransaction (+6 more)

### Community 19 - "AssessmentPage.tsx"
Cohesion: 0.17
Nodes (14): AssessmentPage, ProtectedRoute(), AppShell(), AppShellProps, ShellNavGroup, ShellNavItem, PageHeader(), PageHeaderProps (+6 more)
...
Cohesion: 0.18
Nodes (10): EVENT_META, KarmaCard(), milestones, MilestoneStep, MonthlyCapBar(), PassbookRow(), PILL_ORDER, RightSidebarProps (+2 more)
...
### Community 31 - "ChangePasswordPage"
Cohesion: 0.12
Nodes (8): DashboardRedirect(), ChangePasswordPage(), AdminDashboardCreator, DashboardCreator, DashboardFactory, OfficialDashboardCreator, TrainerDashboardCreator, changePassword()
...
Cohesion: 0.22
Nodes (15): Visual design system (shared by every page), formatDate(), ProfileHeader(), ProfileHeaderProps, AshokaChakra(), CountUp(), GovEmblem(), Reveal() (+7 more)
...
Cohesion: 0.12
Nodes (17): `frontend/src/`, ChatWidget(), ProgressView(), ProgressViewProps, HomeChatWidget(), HomeChatWidgetProps, MessageBubble(), renderMarkdown() (+9 more)

### Community 65 - "api.ts"
Cohesion: 0.21
Nodes (17): TokenBridge(), useLearnerDashboard(), awardKarmaEvent(), fetchAchievements(), fetchEnrollments(), fetchKarmaLedger(), fetchRecommendations(), fetchSkillGapsAndProfile() (+9 more)
...
Cohesion: 0.08
Nodes (22): TODOs / edge cases, AssessmentUploadZone(), AssessmentUploadZoneProps, COLORS, LearningSnapshot(), Props, MyCoursesView(), MyCoursesViewProps (+14 more)
...
## Knowledge Gaps
- **221 isolated node(s):** `graphify`, `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed` (+216 more)
...
- **Why does `7. Mismatches between the mermaid diagram and the code` connect `models/models.py` to `rag.py`, `Code`, `competency.py`, `MockIgotAdapter`, `domain.ts`, `Code`, `EvidenceLog`?**
